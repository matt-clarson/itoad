...
export const tags = ["Fish", "Night-In", "Healthy"];
export const difficulty = "Not-Too-Hard";
export const img = "pan-fried-trout.jpg";
export const date = "2020-06-26";

A dish to wow, that's light on the wallet and on the waistline. If we do say so ourselves, this is a pretty good plate right here - it has a nice mixture of flavours, delicate fish, a sharp, lemon-y sauce, and salty faro - and of textures. There's something satisfying about eating fish and greens punctuated with the crisp trout skin or the delightful crunch of the toasted faro.
...
2. While the faro is cooking, start making the sauce. Melt butter in a saucepan, add mustard and the juice of a whole lemon. Whisk vigorously to emulsify and combine. Season with dill, salt, and black pepper to taste.
